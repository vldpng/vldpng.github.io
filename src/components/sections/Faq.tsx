...
const faqs: FaqItem[] = [
  {
    ...
    a: 'Нет. Лечение проходит под местной анестезией: сначала наносим аппликационный гель, чтобы укол не чувствовался, затем вводим анестетик медленно и в минимальном объёме. Большинство процедур проходят абсолютно комфортно — без боли и страха.',
  },
  {
