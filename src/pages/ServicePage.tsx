...
const serviceDetails: Record<string, { fullDesc: string; benefits: string[]; process: string[] }> = {
  ...
  // whitening сюда не входит: у «Отбеливания зубов» своя страница
  // (WhiteningPage), она перехватывает /services/whitening в App.tsx.
  // aligners сюда не входит: у «Элайнеров» своя страница (AlignersPage),
  // она перехватывает /services/aligners в App.tsx.
  // vector сюда не входит: у «Лечения дёсен Vector» своя страница
  // (VectorPage), она перехватывает /services/vector в App.tsx.
};
