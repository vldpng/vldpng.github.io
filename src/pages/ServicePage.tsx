...
const serviceDetails: Record<string, { fullDesc: string; benefits: string[]; process: string[] }> = {
  ...
  prosthetics: {
    fullDesc: "Протезирование зубов — виниры, накладки и коронки — восстанавливает эстетику и функцию зубов с максимально естественным результатом. Керамика точно повторяет цвет и прозрачность живой эмали.",
    benefits: [
