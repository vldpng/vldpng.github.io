  ...
  return (
    <main>
      <Seo
        ...
        path="/"
        // Тёмная панель под фото героя: на мобильных Topbar скрыт, и сверху
        // сразу идёт затемнённый снимок со белым текстом. Берём брендовый
        // --color-zinc-950 (#041B39) — он же у тёмных секций и Topbar,
        // поэтому полоса читается как часть дизайна, а не как чужой блок.
        themeColor="#041B39"
      />
      <Hero />
      <About />
